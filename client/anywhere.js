(function () {
    ...
    function U() {
        var f = null;
        if ((f = O("oauth_access_token") || O("access_token"))) {
    ...
    F(twttr.anywhere, {
        versions: ["_dev", "1", "chirp_preview", "pre", "1.1", "1.1.1", "1.1.2", "1.1.3", "1.1.4", "1.2.0"],
        _instances: {},
        _clients: [],
        _config: {
            defaultVersion: "1",
            assetHost: "platform{i}.twitter.com",
            secureAssetHost: "twitter-any.s3.amazonaws.com",
